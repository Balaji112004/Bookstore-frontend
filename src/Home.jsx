...
function Home() {
  ...
  // Fetch trending and all books on mount
  useEffect(() => {
    fetchTrending();
    fetchFullBooks();
  }, []);

  // Fetch books by category whenever category changes
  useEffect(() => {
  ...
  // Show selected book details if any
  if (selectedBook) {
    return (
      <div className="mx-auto mt-5 p-6 pb-20 bg-white rounded-xl shadow-lg">
        ...
        <div className="flex flex-col lg:flex lg:flex-row justify-center flex-basis-1 gap-10">
          <img
            src={selectedBook.coverImage}
            alt={selectedBook.title}
            className="lg:h-[470px] h-[320px] w-[200px] ml-[70px] mb-10 lg:mb-0 lg:ml-0 lg:w-[300px] mr-10 object-cover rounded-lg shadow-2xl"
          />
          <div className="flex flex-col  justify-between">
            <div>
              ...
              <div className="text-xl mb-4">
                ...
                <span className="text-md text-green-500 ">
                  {Math.floor(100-selectedBook.newPrice/selectedBook.oldPrice *100)} % off
                </span>
              </div>
            ...
            <div>
              <button
                onClick={addToCart}
                className="bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600 mt-10 lg:mt-0"
              >
                Add to Cart
              </button>
            </div>
